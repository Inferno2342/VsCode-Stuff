...
def get_lan_lon(city_name, state_code, country_code, API_key):
    response = requests.get(f'http://api.openweathermap.org/geo/1.0/direct?q={city_name},{state_code},{country_code}&limit=1&appid={API_key}').json()
...
if __name__ == '__main__':
    lat, lon = get_lan_lon('Los Angeles', 'CA', 'US', api_key)
